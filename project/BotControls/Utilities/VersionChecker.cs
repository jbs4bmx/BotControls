...
namespace DrakiaXYZ.VersionChecker
{
    ...
    public class VersionChecker : Attribute
    {
        ...
        public static bool CheckEftVersion(ManualLogSource Logger, PluginInfo Info, ConfigFile Config = null)
        {
            ...
            int buildVersion = BotControls.bcPlugin.TarkovVersion;
            if (currentVersion != buildVersion)
            {
                string errorMessage = $"ERROR: This version of BotControls v380.0.1 was built for Tarkov {buildVersion}, but you are running {currentVersion}. Please download the correct plugin version.";
